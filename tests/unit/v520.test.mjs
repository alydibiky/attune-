...
// ---- Ali: no information from Wikipedia at all ----
...
eq(rr.map((h) => /wikipedia/.test(h.url)), [false], "v5.22: NO information from Wikipedia — its pages are removed");
eq(rankPassages("x", [W]).length, 0, "…even when it is the only result");
